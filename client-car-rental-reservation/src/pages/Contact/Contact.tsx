...
const Contact: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8">
      <h1 className="text-3xl font-semibold text-gray-800 mb-6 text-center">Get in Touch</h1>
      ...
      <div className="space-y-6 mb-8">
        ...
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="text-gray-600">123 Main St, Suite 101, Springfield, IL 62701, USA</p>
          </div>
        </div>
      </div>
</div>
